...
namespace Dominio
{
    public class Sistema
    {
        ...
        {
            foreach (char ch in unId)
            {
                if (!char.IsDigit(ch)) throw new Exception("NO ES UN NUMERO");
            }
            ...
            esteJugador = GetJugador(id);
            if (esteJugador == null) { throw new Exception("NO EXISTE EL JUGADOR"); }

            foreach (Seleccion seleccion in _selecciones)
            {
                if (seleccion.Pais.Equals(esteJugador.Pais))
                {
                    seEncontro = true;
                    estePais = seleccion.Pais;
                }
            }
            if (!seEncontro) { throw new Exception("NO EXISTE EL SELECCION"); }
            foreach (Partido partido in _partidos)
            {

                if (partido.SeleccionLocal.Pais.Equals(estePais) || partido.SeleccionVisitante.Pais.Equals(estePais))
                {
                    retorno.Add(partido);
                }
            }
        ...
        public void AgregarPeriodista(Periodista periodista)
        {
            ...
            {
                if (periodista.Email == p.Email || periodista.Id == p.Id) { throw new Exception("YA EXISTE ESE PEDIODISTA"); }
            }
            if (periodista.IsValid()) { _periodistas.Add(periodista); }

        }

        public void CambiarPrecioDeReferencia(string precioTexto)
        {
            foreach (char ch in precioTexto)
            {
                if (!char.IsDigit(ch)) throw new Exception("NO ES UN NUMERO");
            }
            double precioReferencia = double.Parse(precioTexto);
            Jugador.ReferenciaPrecio = precioReferencia;
            foreach (Jugador j in _jugadores)
            {
                j.EsVip = j.Precio >= precioReferencia;
            }
        }
        public string MostrarPeriodsitas()
        {
            string returno = "";
            foreach (Periodista p in _periodistas)
            {
        ...
        {
            //SE CREA LISTA DE LOS JUGADORES EXPULSADOS
            List<Jugador> retorno = new List<Jugador>();

            foreach (Partido p in _partidos)
            {

                List<Jugador> jugadoresExpulsados = p.JugadoresExpulsados();
                foreach (Jugador j in jugadoresExpulsados)
                {
                    if (!retorno.Contains(j))
                    {
                        retorno.Add(j);
                    }
                }
            }
            // retorno = OrdenarJugadores(retorno);
            retorno.Sort();
            return retorno;
        ...
        public Seleccion GetSeleccion(string nombre)
        {
        ...
        private void PreCargaPartido()
        {
            ...
            // ESTO SI
            // por fecha 21 del 11
            #region PARTIDOS GRUPOS
            AltaPartido(new FaseGrupos(GetSeleccion("Catar"), GetSeleccion("Ecuador"), new DateTime(2022, 11, 20, 13, 0, 0), "A"));

            AltaPartido(new FaseGrupos(GetSeleccion("Inglaterra"), GetSeleccion("Irán"), new DateTime(2022, 11, 21, 10, 0, 0), "B"));
            AltaPartido(new FaseGrupos(GetSeleccion("Senegal"), GetSeleccion("Países Bajos"), new DateTime(2022, 11, 21, 13, 0, 0), "A"));
            AltaPartido(new FaseGrupos(GetSeleccion("Estados Unidos"), GetSeleccion("Gales"), new DateTime(2022, 11, 21, 16, 0, 0), "B"));


            AltaPartido(new FaseGrupos(GetSeleccion("Arabia Saudita"), GetSeleccion("Argentina"), new DateTime(2022, 11, 26, 7, 0, 0), "C"));
            AltaPartido(new FaseGrupos(GetSeleccion("Dinamarca"), GetSeleccion("Túnez"), new DateTime(2022, 11, 22, 10, 0, 0), "D"));
            AltaPartido(new FaseGrupos(GetSeleccion("México"), GetSeleccion("Polonia"), new DateTime(2022, 11, 22, 13, 0, 0), "C"));
            AltaPartido(new FaseGrupos(GetSeleccion("Francia"), GetSeleccion("Australia"), new DateTime(2022, 11, 22, 16, 0, 0), "D"));

            AltaPartido(new FaseGrupos(GetSeleccion("Marruecos"), GetSeleccion("Croacia"), new DateTime(2022, 11, 23, 7, 0, 0), "F"));
            AltaPartido(new FaseGrupos(GetSeleccion("Alemania"), GetSeleccion("Japón"), new DateTime(2022, 11, 23, 10, 0, 0), "E"));
            AltaPartido(new FaseGrupos(GetSeleccion("España"), GetSeleccion("Costa Rica"), new DateTime(2022, 11, 23, 13, 0, 0), "E"));
            AltaPartido(new FaseGrupos(GetSeleccion("Bélgica"), GetSeleccion("Canadá"), new DateTime(2022, 11, 23, 16, 0, 0), "F"));


            AltaPartido(new FaseGrupos(GetSeleccion("Suiza"), GetSeleccion("Camerún"), new DateTime(2022, 11, 24, 13, 0, 0), "G"));
            AltaPartido(new FaseGrupos(GetSeleccion("Uruguay"), GetSeleccion("Corea del Sur"), new DateTime(2022, 11, 24, 10, 0, 0), "H"));
            AltaPartido(new FaseGrupos(GetSeleccion("Portugal"), GetSeleccion("Ghana"), new DateTime(2022, 11, 24, 13, 0, 0), "H"));
            AltaPartido(new FaseGrupos(GetSeleccion("Brasil"), GetSeleccion("Serbia"), new DateTime(2022, 11, 24, 16, 0, 0), "G"));


            AltaPartido(new FaseGrupos(GetSeleccion("Gales"), GetSeleccion("Irán"), new DateTime(2022, 11, 25, 7, 0, 0), "B"));
            AltaPartido(new FaseGrupos(GetSeleccion("Catar"), GetSeleccion("Senegal"), new DateTime(2022, 11, 25, 10, 0, 0), "A"));
            AltaPartido(new FaseGrupos(GetSeleccion("Países Bajos"), GetSeleccion("Ecuador"), new DateTime(2022, 11, 25, 13, 0, 0), "A"));
            AltaPartido(new FaseGrupos(GetSeleccion("Inglaterra"), GetSeleccion("Estados Unidos"), new DateTime(2022, 11, 25, 16, 0, 0), "B"));


            AltaPartido(new FaseGrupos(GetSeleccion("Túnez"), GetSeleccion("Australia"), new DateTime(2022, 11, 26, 7, 0, 0), "D"));
            AltaPartido(new FaseGrupos(GetSeleccion("Polonia"), GetSeleccion("Arabia Saudita"), new DateTime(2022, 11, 26, 10, 0, 0), "C"));
            AltaPartido(new FaseGrupos(GetSeleccion("Francia"), GetSeleccion("Dinamarca"), new DateTime(2022, 11, 26, 13, 0, 0), "D"));
            AltaPartido(new FaseGrupos(GetSeleccion("Argentina"), GetSeleccion("México"), new DateTime(2022, 11, 26, 16, 0, 0), "C"));

            AltaPartido(new FaseGrupos(GetSeleccion("Japón"), GetSeleccion("Costa Rica"), new DateTime(2022, 11, 27, 7, 0, 0), "E"));
            AltaPartido(new FaseGrupos(GetSeleccion("Bélgica"), GetSeleccion("Marruecos"), new DateTime(2022, 11, 27, 10, 0, 0), "F"));
            AltaPartido(new FaseGrupos(GetSeleccion("Croacia"), GetSeleccion("Canadá"), new DateTime(2022, 11, 27, 13, 0, 0), "F"));
            AltaPartido(new FaseGrupos(GetSeleccion("España"), GetSeleccion("Alemania"), new DateTime(2022, 11, 27, 16, 0, 0), "E"));

            AltaPartido(new FaseGrupos(GetSeleccion("Camerún"), GetSeleccion("Serbia"), new DateTime(2022, 11, 28, 7, 0, 0), "G"));
            AltaPartido(new FaseGrupos(GetSeleccion("Corea del Sur"), GetSeleccion("Ghana"), new DateTime(2022, 11, 28, 10, 0, 0), "H"));
            AltaPartido(new FaseGrupos(GetSeleccion("Brasil"), GetSeleccion("Suiza"), new DateTime(2022, 11, 28, 13, 0, 0), "G"));
            AltaPartido(new FaseGrupos(GetSeleccion("Portugal"), GetSeleccion("Uruguay"), new DateTime(2022, 11, 28, 16, 0, 0), "H"));


            AltaPartido(new FaseGrupos(GetSeleccion("Ecuador"), GetSeleccion("Senegal"), new DateTime(2022, 11, 29, 12, 0, 0), "A"));
            AltaPartido(new FaseGrupos(GetSeleccion("Países Bajos"), GetSeleccion("Catar"), new DateTime(2022, 11, 29, 12, 0, 0), "A"));
            AltaPartido(new FaseGrupos(GetSeleccion("Estados Unidos"), GetSeleccion("Irán"), new DateTime(2022, 11, 29, 16, 0, 0), "B"));
            AltaPartido(new FaseGrupos(GetSeleccion("Gales"), GetSeleccion("Inglaterra"), new DateTime(2022, 11, 29, 16, 0, 0), "B"));

            AltaPartido(new FaseGrupos(GetSeleccion("Túnez"), GetSeleccion("Francia"), new DateTime(2022, 11, 30, 12, 0, 0), "D"));
            AltaPartido(new FaseGrupos(GetSeleccion("Australia"), GetSeleccion("Dinamarca"), new DateTime(2022, 11, 30, 12, 0, 0), "D"));
            AltaPartido(new FaseGrupos(GetSeleccion("Polonia"), GetSeleccion("Argentina"), new DateTime(2022, 11, 30, 16, 0, 0), "C"));
            AltaPartido(new FaseGrupos(GetSeleccion("Arabia Saudita"), GetSeleccion("México"), new DateTime(2022, 11, 30, 16, 0, 0), "C"));

            AltaPartido(new FaseGrupos(GetSeleccion("Croacia"), GetSeleccion("Bélgica"), new DateTime(2022, 12, 1, 12, 0, 0), "F"));
            AltaPartido(new FaseGrupos(GetSeleccion("Canadá"), GetSeleccion("Marruecos"), new DateTime(2022, 12, 1, 12, 0, 0), "F"));
            AltaPartido(new FaseGrupos(GetSeleccion("Japón"), GetSeleccion("España"), new DateTime(2022, 12, 1, 16, 0, 0), "E"));
            AltaPartido(new FaseGrupos(GetSeleccion("Costa Rica"), GetSeleccion("Alemania"), new DateTime(2022, 12, 1, 16, 0, 0), "E"));

            AltaPartido(new FaseGrupos(GetSeleccion("Corea del Sur"), GetSeleccion("Portugal"), new DateTime(2022, 12, 2, 12, 0, 0), "H"));
            AltaPartido(new FaseGrupos(GetSeleccion("Ghana"), GetSeleccion("Uruguay"), new DateTime(2022, 12, 2, 12, 0, 0), "H"));
            AltaPartido(new FaseGrupos(GetSeleccion("Serbia"), GetSeleccion("Suiza"), new DateTime(2022, 12, 2, 16, 0, 0), "G"));
            AltaPartido(new FaseGrupos(GetSeleccion("Camerún"), GetSeleccion("Brasil"), new DateTime(2022, 12, 2, 16, 0, 0), "G"));
            #endregion

            #region PARTIDOS ELIMINATORIA
            AltaPartido(new FaseEliminatoria(GetSeleccion("Catar"), GetSeleccion("Senegal"), new DateTime(2022, 12, 3, 12, 0, 0), true, true, "ocatavos"));
            AltaPartido(new FaseEliminatoria(GetSeleccion("Irán"), GetSeleccion("Ecuador"), new DateTime(2022, 12, 4, 12, 0, 0), true, false, "ocatavos"));
            AltaPartido(new FaseEliminatoria(GetSeleccion("Catar"), GetSeleccion("Irán"), new DateTime(2022, 12, 7, 12, 0, 0), false, false, "cuartos"));
        ...
        private void PreCargaIncidencia()
        {
            ...
            _jugadores[52].AgregarIncidencia(_partidos[0], TipoDeIncidencia.GOL, 60);
            _jugadores[53].AgregarIncidencia(_partidos[0], TipoDeIncidencia.GOL, 62);
            _jugadores[54].AgregarIncidencia(_partidos[0], TipoDeIncidencia.GOL, 64);
            _jugadores[54].AgregarIncidencia(_partidos[0], TipoDeIncidencia.GOL, 70);
            _jugadores[29].AgregarIncidencia(_partidos[0], TipoDeIncidencia.AMARILLA, 1);
            _jugadores[28].AgregarIncidencia(_partidos[0], TipoDeIncidencia.ROJA, 1);

            _jugadores[454].AgregarIncidencia(_partidos[0], TipoDeIncidencia.GOL, 1);

            _jugadores[454].AgregarIncidencia(_partidos[0], TipoDeIncidencia.ROJA, 20);
            ...
            _jugadores[364].AgregarIncidencia(_partidos[1], TipoDeIncidencia.GOL, 30);
            _jugadores[363].AgregarIncidencia(_partidos[1], TipoDeIncidencia.GOL, 21);
            ...
            _jugadores[587].AgregarIncidencia(_partidos[2], TipoDeIncidencia.GOL, 56);
            ...
            _jugadores[808].AgregarIncidencia(_partidos[3], TipoDeIncidencia.GOL, 58);
            ...
            _jugadores[355].AgregarIncidencia(_partidos[16], TipoDeIncidencia.GOL, 80);
            _jugadores[355].AgregarIncidencia(_partidos[16], TipoDeIncidencia.GOL, 89);


            _jugadores[808].AgregarIncidencia(_partidos[16], TipoDeIncidencia.GOL, 58);
            ...
            _jugadores[52].AgregarIncidencia(_partidos[17], TipoDeIncidencia.GOL, 14);
            _jugadores[52].AgregarIncidencia(_partidos[17], TipoDeIncidencia.GOL, 23);
            _jugadores[52].AgregarIncidencia(_partidos[17], TipoDeIncidencia.GOL, 35);

            _jugadores[587].AgregarIncidencia(_partidos[17], TipoDeIncidencia.GOL, 67);
            ...
            _jugadores[456].AgregarIncidencia(_partidos[18], TipoDeIncidencia.GOL, 14);
            ...
            _jugadores[266].AgregarIncidencia(_partidos[19], TipoDeIncidencia.GOL, 14);
            ...
            _jugadores[587].AgregarIncidencia(_partidos[32], TipoDeIncidencia.GOL, 14);

            _jugadores[587].AgregarIncidencia(_partidos[32], TipoDeIncidencia.AMARILLA, 85);
            _jugadores[587].AgregarIncidencia(_partidos[32], TipoDeIncidencia.ROJA, 86);
            #endregion

            #region decimo partido paises bajos 0 catar 1 
            _jugadores[52].AgregarIncidencia(_partidos[33], TipoDeIncidencia.GOL, 14);

            _jugadores[52].AgregarIncidencia(_partidos[33], TipoDeIncidencia.AMARILLA, 85);
            _jugadores[52].AgregarIncidencia(_partidos[33], TipoDeIncidencia.ROJA, 86);
            #endregion

            #region onceavo parido eeuu 0 iran 1  iran +3
            _jugadores[356].AgregarIncidencia(_partidos[34], TipoDeIncidencia.GOL, 14);

            _jugadores[356].AgregarIncidencia(_partidos[34], TipoDeIncidencia.AMARILLA, 85);
            _jugadores[359].AgregarIncidencia(_partidos[34], TipoDeIncidencia.ROJA, 86);
            #endregion

            #region decimosegundo partido gales 2  inglaterra 0 gales +3 
            _jugadores[808].AgregarIncidencia(_partidos[35], TipoDeIncidencia.GOL, 80);
            _jugadores[808].AgregarIncidencia(_partidos[35], TipoDeIncidencia.GOL, 89);

            _jugadores[808].AgregarIncidencia(_partidos[35], TipoDeIncidencia.AMARILLA, 1);
            _jugadores[808].AgregarIncidencia(_partidos[35], TipoDeIncidencia.ROJA, 1);
            #endregion

            #region partido eliminatoria 1  catar 1(1)  senegal 1(0)  
            _jugadores[44].AgregarIncidencia(_partidos[48], TipoDeIncidencia.GOL, 23);

            _jugadores[592].AgregarIncidencia(_partidos[48], TipoDeIncidencia.GOL, 60);

            _jugadores[44].AgregarIncidencia(_partidos[48], TipoDeIncidencia.GOL, -1);
            ...
            _jugadores[371].AgregarIncidencia(_partidos[49], TipoDeIncidencia.GOL, 80);
            _jugadores[365].AgregarIncidencia(_partidos[49], TipoDeIncidencia.GOL, 105);

            _jugadores[475].AgregarIncidencia(_partidos[49], TipoDeIncidencia.GOL, 89);
            ...
            #region partido eliminatoria 3  catar 1  iran 0
            _jugadores[45].AgregarIncidencia(_partidos[50], TipoDeIncidencia.GOL, 89);


            _jugadores[39].AgregarIncidencia(_partidos[50], TipoDeIncidencia.AMARILLA, 23);
            _jugadores[42].AgregarIncidencia(_partidos[50], TipoDeIncidencia.ROJA, 87);
            #endregion

        }

        public List<Partido> GetPartidos(Seleccion seleccion)
        {
            List<Partido> partidos = new List<Partido>();

            foreach (Partido unPartido in _partidos)
            {
                if (unPartido.SeleccionLocal.Equals(seleccion) || unPartido.SeleccionVisitante.Equals(seleccion))
                {
        ...
        public List<Partido> MasGolesDeSeleccion(string nombre)
        {
            ...
            if (seleccion == null)
            {
                throw new Exception("NO EXISTE UNA SELECCION CON ESE NOMBRE");
            }

            List<Partido> partidosJugados = GetPartidos(seleccion);
            if (partidosJugados.Count == 0)
            {
                throw new Exception("NO TIENE PARTIDOS JUGADOS");
            }
            return GetParidoConMasGoles(partidosJugados);
        }
        public List<Jugador> JugadoresConGol()
        {
            ...
            foreach (Partido partido in _partidos)
            {
                List<Jugador> jugadoresConGol = partido.JugadoresConGol();

                foreach (Jugador jugador in jugadoresConGol)
                {

                    if (!retorno.Contains(jugador))
                    {
                        retorno.Add(jugador);
                    }
                }
